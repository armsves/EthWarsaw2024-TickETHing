    ...
    <main className="flex flex-col gap-4 max-w-[1200px] w-full h-screen mx-auto px-5 py-8">
      <div className="flex items-center gap-4">
        <Image
          ...
          height={100}
        />
        <h1 className="font-bold text-2xl">TickETHing for your web3 tickets</h1>
      </div>
...
*/
      ...
      <div className="flex w-full justify-between">
        ...
        <div className="w-[50%]">
          <PaymentWidget
            sellerAddress="0x9567D433240681653fb4DD3E05e08D60fe54210d"
            supportedCurrencies={[
              "MNT-mantle",
              "ETH-sepolia-sepolia",
              "DAI-optimism",
            ...
            onPaymentSuccess={(request) => {
              //TODO mint nft to user here

            }}
          />
        </div>
      </div>
      <footer className="mt-auto flex justify-between items-center w-full">
        <Image src="/request.svg" alt="Image 3" width={100} height={100} className="object-cover rounded-full" />
        <Image src="/mantle.png" alt="Image 1" width={100} height={100} className="object-cover rounded-full" />
        <Image src="/optimism.png" alt="Image 2" width={100} height={100} className="object-cover rounded-full" />
        <Image src="/celo.png" alt="Image 4" width={100} height={100} className="object-cover rounded-full" />
      </footer>
    </main>
  );
}
